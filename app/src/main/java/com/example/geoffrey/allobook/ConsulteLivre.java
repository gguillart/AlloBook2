...
public class ConsulteLivre extends ActionBarActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        if (!mNavigationDrawerFragment.isDrawerOpen()) {
            ...
            getMenuInflater().inflate(R.menu.consulte_livre, menu);
            restoreActionBar();
            return true;
        }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_consulte_livre, container, false);
            return rootView;
        }
        ...
        public void onAttach(Activity activity) {
            ...
            ((ConsulteLivre) activity).onSectionAttached(
